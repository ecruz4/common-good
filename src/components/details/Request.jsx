...
export default function Request({ doc }) {
  ...
  const { productId, userId, title, emergency, description, quantity, date } =
    doc;
      ...
      <Card className={classes.card}>
        <Grid container direction="row">
          <Grid item xs={6}>
            {emergency ? (
              <img
                src="https://images.unsplash.com/photo-1559199882-6959a71820bc?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=1431&q=80"
                className={classes.image}
              ></img>
            ) : (
              <img
                src="https://images.unsplash.com/photo-1532629345422-7515f3d16bb6?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1050&q=80"
                className={classes.image}
              ></img>
            )}
          </Grid>
        ...
        {org.zipcode ? <Map zip={org.zipcode} pic={org.photo_url} /> : null}
        {org.bio ? (
